...
router.post('/send_otp_v2', nuser_controller.user_send_otpv2);
...
router.get('/top_notification_badge',helpdesk_controller.get_dashboard_unread_noti_helpdesk)


//router.post('/myip',nuser_controller.check_ip)
