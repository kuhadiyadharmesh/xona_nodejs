...
var cron_check = cron.schedule('01 10 18 * * *',()=>{
    var day_today=dateFormat(new Date(new Date().setDate(new Date().getDate())), "yyyymmdd");
    console.log('check -- service will start in next 20 minutes ...')
...
/*
//  var cron_target_count = cron.schedule('55 07 13 * * *', () =>{
...
//var cron_advertise_live = cron.schedule('01 20 22 * * *',() =>{
    var cron_advertise_live = cron.schedule('01 32 19 * * *',() =>{
        make_live_ads()
    })
