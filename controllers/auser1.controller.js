    ...
    CommonFile.admin_auth(req.headers.token , (err , value)=>
    {
        ...
        else
        {
            ...
            if(is_approve == 2)
                ...
                User.findByIdAndUpdate({_id : user_id , is_admin_approve : 0 , is_verify : true , is_active : true },{$set :{is_admin_approve : is_approve ,update_date:cdate}},function(err , user){
                    if(err)
                    {
