...
exports.add_withdraw_request = function(req , res)
{
    NCommonFile.nuser_check_authWithData(req.headers.token , (err , nuserData)=>{
        ...
        {
            NCommonFile.nuser_check_profile(req.headers.token , (err , percent_profile)=>
            {
                if(err)
                {
                    ...
                    if(nuserData.point_balance >= points)
                    {
                        NCommonFile.withdraw_point_validation(points , (err , withData)=>
                        {
                            ...
                            else
                            {
                                ...
                                console.log(paytm_mobile)
                                NUser.findOneAndUpdate({_id : nuserData._id},{$set : {point_balance : (nuserData.point_balance - points) , update_date: ddt }} , function(err , nuser){
                                    if(err)
                                    {
